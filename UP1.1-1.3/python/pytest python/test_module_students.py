...
def test_wrong_stip():
    with pytest.raises(ValueError):
        employee_1 = Student(1, "Комаров Д.А", "27.11.2002", -100)
...
def test_wrong_type_student_num():
    with pytest.raises(TypeError):
        employee_1 = Student("1", "Комаров Д.А", "27.11.2002", 10000)


# Проверяем увеличение стипендии
def test_increase_stip():
    employee_1 = Student(1, "Комаров Д.А", "11.11.2002", 10000)
...
def test_employees_lt():
    employee_1 = Student(1, "Комаров Д.А", "11.11.2002", 10000)
    employee_2 = Student(2, "Комаров Д.А", "11.11.2002", 10000)
...
def test_wrong_type_Department():
    with pytest.raises(TypeError):
        ...
        dep_1 = Department("Студент", "Комаров Д.А")
