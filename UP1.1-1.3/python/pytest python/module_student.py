...
class Student:
    ...
    def __str__(self):
        return f"Студент {self.number} {self.fio}, {self.bdate}," \
               f" стипендия: {self.salary}, на чиле: {'да' if self.on_leave else 'нет'}"
...
class Department:
    ...
    def __str__(self):
        return f"Группа 195: {self.title}, Лучший в мире куратор: Гришакова Татьяна Николаевна, Количество студентов: {len(self.employees)} "

    # Вывод студентов отдела
...
emp_1 = Student(1, 'Савицкий Даниил Константинович', '11.08.2003', 1530)
emp_2 = Student(2, 'Меринов Дмитрий Саныч', '12.04.2002', 1590)
...
depart_1 = Department('Группа студентов', emp_1)
