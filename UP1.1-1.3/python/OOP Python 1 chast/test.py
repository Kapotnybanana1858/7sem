...
class Department:
    ...
    def __str__(self):
        return f"Группа 195: {self.title}, Куратор: Гришакова Татьяна Николаевна, Количество студентов: 6 "
...
emp_1 = Students(1, 'Савицкий Даниил Валентинович', '10.02.2003', 1410)
emp_2 = Students(2, 'Комаров Данила Алексеевич', '16.02.2005', 530)
emp_3 = Students(3, 'Карабчиков Денис Викторович', '02.04.2002', 0)
emp_4 = Students(4, 'Буланина Анастасия Сергеевна', '01.01.2001', 230)
emp_5 = Students(5, 'Лидовской Иван Николаевич', '21.11.2002', 230)
emp_6 = Students(6, 'Демченков Вадим Сергеевич', '11.08.2000', 530)
emp_7 = Students(7, 'Будаев Владимир Владимирович', '12.02.2001', 1590)
emp_8 = Students(8, 'Ершов Владислав Владимирович', '22.05.2002', 530)
emp_9 = Students(9, 'Калашников Михаил Викторович', '19.03.2004', 230)
emp_10 = Students(10, 'Меринов Дмитрий Александрович', '16.08.2004', 530)
